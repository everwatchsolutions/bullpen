...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .background-color {
      background-color: rgba(29, 136, 202, 1) !important;
    }
  ...
  <body class="plain error-page-wrapper background-color background-image">
    ...
    <p>
      ...
      If this happens again please report the problem.
    </p>


    </div>
	<div class="buttons-container">
            <a class="border-button" href="/dashboard" target="">Go To Homepage</a>
		<a class="border-button" href="mailto:dylan.kolson@acesinc.net" target="_blank">Report A Problem</a>
	</div>
</div>
